<form action="<?php echo BASE_URL . "/products/store" ?>" method="post" enctype="multipart/form-data">
    <div class="edit__container">
        ...
        <textarea name="description" id="description" class="edit__input" placeholder="Description"></textarea>

        <label for="category">Category</label>
        <input type="text" name="category" id="category" placeholder="Category" class="edit__input" value="" required>
