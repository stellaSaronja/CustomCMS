<header>
    <nav>
        ...
        <button class="nav__menu">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 124 124" fill="#fff" class="menuIcon">
        ...
        <ul class="nav__ul">
            <li class="nav__item">
                <a class="nav__link" href="<?php echo BASE_URL; ?>/home">Home</a>
            </li>
            <li class="nav__item">
                <a class="nav__link" href="<?php echo BASE_URL; ?>/products">Products</a>
            </li>     
            <li class="nav__item">
            ...
            <li class="nav__item">
                <?php if(App\Models\User::isLoggedIn()): ?>
                    <a href="<?php echo BASE_URL; ?>/logout" class="nav__link">Log out</a>
                <?php else : ?>
                    <a href="<?php echo BASE_URL; ?>/login" class="nav__link">
